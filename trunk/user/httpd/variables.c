...
#include "common.h"
	...
	struct variable variables_Storage[] = {
			{"computer_name", "", NULL, EVM_RESTART_DHCPD|EVM_RESTART_NMBD|EVM_RESTART_DMS|EVM_RESTART_ITUNES},
#if defined(APP_SMBD)
...
#endif
#if defined(APP_SMBD)
			{"st_max_user", "", NULL, EVM_RESTART_SMBD},
			{"acc_num", "", NULL, EVM_RESTART_SMBD},
#endif
...
#endif
			{"Storage_UserList", "Group", ARGV((char*)variables_Storage_UserList, "16", "79", "acc_num"), EVM_RESTART_SMBD},
			{0,0,0,0}
		};
