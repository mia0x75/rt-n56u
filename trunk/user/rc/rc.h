...
#define SCRIPT_POST_WAN			"/etc/post_wan_script.sh"
#define SCRIPT_POST_FIREWALL		"/etc/post_iptables_script.sh"
#define SCRIPT_INTERNET_STATE		"/etc/inet_state_script.sh"
#define SCRIPT_SHUTDOWN			"/etc/shutdown_script.sh"
...
#define VPN_SERVER_UPDOWN_SCRIPT	"/etc/vpns_client_script.sh"

#define VPN_CLIENT_PPPD_OPTIONS		"/tmp/ppp/options.vpnc"
#define VPN_CLIENT_UPDOWN_SCRIPT	"/etc/vpnc_server_script.sh"
